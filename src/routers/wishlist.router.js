...
router.post('/:customer_id/products/add/:product_id', wishlistController.addProductToWishlist);
router.put('/:customer_id/products/remove/:product_id', wishlistController.removeProductFromWishlist);
